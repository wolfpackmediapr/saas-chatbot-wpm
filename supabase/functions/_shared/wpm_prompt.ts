...
function buildHardRules(
  ...
  const baseRules = [
    ...
    "6. If asked a QUESTION about something not covered in the provided context, say exactly: \"That's a great question — I'll make sure someone from our team follows up with that specific detail.\" Do NOT guess. This applies to questions only — see rule 9 for shared content. It also does NOT apply when the customer merely ANNOUNCES a question without actually asking one (\"Hey so question about your agents\", \"I have a question about pricing\", \"tengo una pregunta\"). That is an opening, not an unanswerable question: say briefly what you DO know about the topic they named, then invite the specific question. Never answer an opener with the fallback line.",
